...
public class PatternsTestModeTest {
    @BeforeEach
    void setup() {
    ...
    void shouldSuccessfulLoginIfRegisteredActiveUser() {
        ...
        $("button.button").click();
        $("h2").shouldBe(visible, Duration.ofSeconds(20))
    ...
    void shouldGetErrorIfNotRegisteredUser() {
        ...
        $("button.button").click();
        $("[data-test-id= 'error-notification'] .notification__content").shouldBe(visible, Duration.ofSeconds(20))
